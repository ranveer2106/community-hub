    ...
    <>
      <div className='navbar flex justify-between  '>
        ...
        <ul className='flex items-center	nav-main'>
          ...
          <Link to="/personal" className="navbtn">Personal</Link>
          <Link to="/feed" className="navbtn">Feed</Link>
          <Link to="/admin" className="navbtn">Admin</Link>
          ...
          {!token ? <button onClick={() => setshowLogin(true)} className='loginbtn '>Login</button>
            : <div className='navbar-profile'>
              ...
              <ul className="nav-profile-dropdown">
                <li onClick={() => navigate('/myorders')} className='mb-2'>Orders</li>
                <hr />
